...
public class Constants {
    ...
    public static final String SECTION_NOT_REQUIRED = "Section and Train ID must not be blank";

    public static final String EMAIL_ID_NOT_BLANK = "Email ID must not be blank";
    ...
    public static final String API_USER_DETAILS_BY_SEC = "/section";
